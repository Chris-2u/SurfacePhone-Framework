...
public: 
    ...
    bool isCircular(){
        return abs(angleBoundingRect.width-angleBoundingRect.height) < 0.3;
        
        bool rta = false;
        
        // cout << "Width-Height: " << abs(boundingRect.width-boundingRect.height) << endl;
        
        if ( abs(boundingRect.width-boundingRect.height) < 0.2 ){
...
//            cout << "Circle found: Min-Max: " << abs(maxDistance - minDistance) << endl;
